...
class APIKeyManager:
    ...
    def encrypt_api_key(self, plain_key: str) -> str:
        ...
        response = self.kms.encrypt(
            KeyId=self.kms_key_id, Plaintext=plain_key.encode("utf-8")
        )
    ...
    def save_api_keys(self, user_id: str, api_keys: Dict[str, str]):
        ...
        self.table.put_item(Item={"user_id": user_id, "api_keys": encrypted_keys})
...
def get_api_key_manager(
    session: boto3.Session, table_name: str, kms_key_id: str
) -> APIKeyManager:
    global _key_manager
